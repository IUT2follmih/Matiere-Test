(function () {
  ...
  Promise.all([
    fetch('./assets/maps/grass.json'), // fichier contenant les tuiles
    fetch('./assets/maps/reachability.json'), // fichier contenant les accès
    fetch('./assets/maps/decorations.json') // fichier contenant les décorations
  ]).then((data) => {
